//! Application service for a single synthetic BAS execution.
//!
//! This module owns the critical execution path independently from the HTTP
//! transport: integrity verification, runner resolution/dispatch, telemetry,
//! signed audit persistence, and lifecycle webhooks. Keeping these concerns out
//! of `http.rs` lets REST, campaigns, and the scheduler share one execution
//! boundary without turning the transport layer into the application core.
