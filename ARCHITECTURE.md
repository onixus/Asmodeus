...
Текущий контракт жизненного цикла, происхождения метрик, persistent catalogs
и исполняемого DSL: [функции от 22 сентября 2026](docs/features-2026-09-22.ru.md).
Описание ниже включает целевую архитектуру; подтверждённые границы реализации
и приёмочные проверки перечислены в этом контракте.
...
**Проверка реализации (2026-09-22):** [обзор архитектуры](docs/architecture-review-2026-09-22.ru.md)
фиксирует реализованные исправления и незакрытые расхождения с целевыми
инвариантами ниже, включая remote abort, dead-man switch и изоляцию раннера.
Постоянный JSONL-аудит требует отдельного `ASMODEUS_AUDIT_SIGNING_KEY`.
