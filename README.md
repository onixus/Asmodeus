...
Реализованы фоновый запуск, отмена по run ID, подтверждение cleanup, постоянные
кампании/расписания и исполнение параметров подписанного DSL. До явного Blue Team
feedback результат имеет `PENDING_FEEDBACK`; симуляция исключена из метрик защиты.
Настройка, API/CLI, ключи, миграция ClickHouse и границы реализации описаны в
[контракте новых функций](docs/features-2026-09-22.ru.md).
